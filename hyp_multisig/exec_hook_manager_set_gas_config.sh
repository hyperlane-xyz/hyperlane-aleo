...
$LEO execute --skip-proving --yes --broadcast hyp_multisig.aleo/init_multisig_op $SIGNING_OP_ID $BLOCK_EXPIRATION "{op: 20u8, arg_addr_0: $IGP, arg_addr_1: aleo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3ljyzc, arg_addr_2: aleo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3ljyzc, arg_addr_3: aleo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3ljyzc, arg_u128_0: ${DST_DOMAIN}u128, arg_u128_1: ${GAS_OVERHEAD}u128, arg_u128_2: ${EXCHANGE_RATE}u128, arg_u128_3: ${GAS_PRICE}u128}"
...
$LEO execute --skip-proving --yes --broadcast hyp_multisig.aleo/exec_hook_mgr_set_gas_config $SIGNING_OP_ID $IGP ${DST_DOMAIN}u32 "{gas_overhead: ${GAS_OVERHEAD}u128, exchange_rate: ${EXCHANGE_RATE}u128, gas_price: ${GAS_PRICE}u128}"
