...
$LEO execute --skip-execute-proof --yes --broadcast hyp_multisig_core.aleo/initiate_signing_op hyp_multisig.aleo $SIGNING_OP_ID $BLOCK_EXPIRATION

PRIVATE_KEY=APrivateKey1zkp2RWGDcde3efb89rjhME1VYA8QMxcxep5DShNBR6n8Yjh $LEO execute --skip-execute-proof --yes --broadcast hyp_multisig_core.aleo/sign hyp_multisig.aleo $SIGNING_OP_ID
