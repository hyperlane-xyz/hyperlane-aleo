...
4. Init mailbox: `$LEO execute --skip-execute-proof --broadcast --yes hyp_mailbox.aleo/init 1u32`
5. Init hyp_multisig (this configures the signers set): See exec_init.sh
6. Switch the mailbox owner to hyp_multisig.aleo: `$LEO execute --skip-execute-proof --broadcast --yes hyp_mailbox.aleo/set_owner hyp_multisig.aleo`
