...
$LEO execute --skip-proving --yes --broadcast hyp_collateral_multisig.aleo/init_multisig_op $SIGNING_OP_ID "{op: 4u8, arg_addr_0: aleo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3ljyzc, arg_addr_1: aleo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3ljyzc, arg_addr_2: aleo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3ljyzc, arg_addr_3: aleo1qqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqqq3ljyzc, arg_u128_0: ${DESTINATION}u128, arg_u128_1: ${GAS}u128, arg_u128_2: 0u128, arg_u128_3: 0u128, arg_bytes: $RECIPIENT}"
...
$LEO execute --skip-proving --yes --broadcast hyp_collateral_multisig.aleo/exec_enroll_remote_router $SIGNING_OP_ID ${DESTINATION}u32  "$RECIPIENT" ${GAS}u128
